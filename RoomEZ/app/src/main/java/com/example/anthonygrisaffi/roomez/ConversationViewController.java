...
public class ConversationViewController implements View.OnClickListener, LayerChangeEventListener.MainThread, TextWatcher, LayerTypingIndicatorListener {
    ...
    public ConversationViewController(GroupMessage ma, LayerClient client) {
        ...
        //Change the layout
        ma.setContentView(R.layout.activity_group_message);
    ...
    private void sendButtonClicked(){
        ...
        if(activeConversation == null){
            ...
            if(activeConversation == null){
                activeConversation = layerClient.newConversation(GroupMessage.getAllParticipants());
            }
        }
    ...
    private void sendMessage(String text) {
        ...
        metadata.put("layer-push-message", GroupMessage.getUserID() + ": " + text);
    ...
    public static String getInitialMessage(){
        return "Hey, everyone! This is your friend, " + GroupMessage.getUserID();
    }
